<template>
  ...
  >
    ...
    <form class="mt-4 space-y-4" @submit.prevent="handleChangePassword">
      <div class="space-y-2">
        <Label>
          <AppIcon  name="lock" class="mr-1" /> 当前密码 <span class="text-red-600">*</span>
        </Label>
        <Input
      ...
      <div class="space-y-2">
        <Label>
          <AppIcon  name="key" class="mr-1" /> 新密码 <span class="text-red-600">*</span>
        </Label>
        <Input
      ...
      <div class="space-y-2">
        <Label>
          <AppIcon  name="key" class="mr-1" /> 确认新密码 <span class="text-red-600">*</span>
        </Label>
        <Input
